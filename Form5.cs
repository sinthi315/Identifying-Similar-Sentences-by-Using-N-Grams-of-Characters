    ...
    public partial class Form5 : Form
    {
        ...
        private void roundedButton1_Click(object sender, EventArgs e)
        {
            ...
            if ((textBox1.Text != null) && (Uri.IsWellFormedUriString(textBox1.Text, UriKind.Absolute)) && (textBox3.Text != null) && (Uri.IsWellFormedUriString(textBox3.Text, UriKind.Absolute)) && (textBox2.Text != null))
            {
                ...
                listNGram1 = createNGramTextENG(extractStringURL1, nGramSize);
                listNGram2 = createNGramTextFRN(extractStringURL2, nGramSize);
                ...
                textBox3.Clear();
                stopwatch.Stop();
                richTextBox1.AppendText("Eime elapsed: " + stopwatch.Elapsed);
            }
        ...
        private List<string> createNGramTextENG(string textList, int nGramSize)
        {
            string filteredLine = "";
            string line = "";
        ...
        private List<string> createNGramTextFRN(string textList, int nGramSize)
        {
            string filteredLine = "";
            string line = "";
            List<string> listNGram = new List<string>();
