...
namespace Detecting_Similarities
{
    public partial class Form4 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int nGramSize = Convert.ToInt32(textBox3.Text);
            if (nGramSize == 0)
            {
            ...
            if ((textBox1.Text != null) && (textBox2.Text != null) && (textBox3.Text != null))
            {
                ...
                listNGram1 = createNGramTextENG(text1, nGramSize);
                listNGram2 = createNGramTextFRN(text2, nGramSize);
        ...
        private List<string> createNGramTextENG(List<string> textList, int nGramSize)
        {
            string filteredLine = "";
            ...
            foreach (string s in textList)
            {
                if (s != null)
                {
                    richTextBox1.AppendText("Raw Data1: " + "'" + s + "'" + "\n");
                    filteredLine = StopwordTool.RemoveStopwords(s).ToLower();
                    richTextBox1.AppendText("Filtered Data1: " + "'" + filteredLine + "'" + "\n");
        ...
        private List<string> GetTextFromText(string path)
        {
            ...
            StreamReader sr1 = new StreamReader(bs1, Encoding.Default, true);
